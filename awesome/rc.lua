...
awful.rules.rules = {
    ...
    { rule_any = { class = { "MPlayer", "pinentry", "Gimp", "Shutter" } },
      properties = { floating = true } },
    { rule = { class = "Gajim", role = "preferences" },
      properties = { floating = true } },
...
run_once("xfce4-volumed",
         ...
         nil,
         nil)
awful.util.spawn_with_shell("pactl unload-module module-bluetooth-discover && pactl load-module module-bluetooth-discover ")
